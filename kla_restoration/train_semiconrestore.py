"""
Training script for SemiconRestore-DA (degradation-aware NAFNet extension).
Usage: python train_semiconrestore.py
"""
...
VAL_SPLIT = 0.1
NUM_WORKERS = 4
CHECKPOINT_DIR = "checkpoints_semiconrestore"
...
def main():
    ...
    model = SemiconRestoreDA(
        ...
        dec_blocks=DEC_BLOCKS, z_dim=Z_DIM, asinh_scale=ASINH_SCALE,
    ).to(DEVICE)
    ...
    print(f"\nTraining complete. Best val PSNR: {best_val_psnr:.2f}dB (full-image, reliable)")
